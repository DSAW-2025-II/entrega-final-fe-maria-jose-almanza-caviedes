...
describe("Auth routes", () => {
  ...
  it("allows switching roles while keeping a single active role", async () => {
    const payload = {
    ...
    expect(driverSwitch.body?.user?.roles).toContain("driver");
    expect(driverSwitch.body?.user?.roles).toContain("passenger");
    ...
    expect(passengerSwitch.body?.user?.roles).toContain("driver");
    expect(passengerSwitch.body?.user?.roles).toContain("passenger");
  });
